...
/*   Updated: 2019/02/07 15:13:01 by aquan            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
//	if (param->tool->step < 20 || param->tool->step > 1)
	{
		...
		{
			ft_bzero(param->img_str, sizeof(int) * param->win_h * param->win_w);
			afficher(param);
		}
		else
		{
...
{
//	if (param->tool->left < param->win_w)
	{
